class TicketPdf < Prawn::Document
  ...
  def initialize(order)
    ...
    qr_code = Barby::QrCode.new(@order.order_id)
    ...
    bounding_box([0, cursor], width: bounds.width, height: height) do
      ...
      bounding_box([0, cursor], width: info_w, height: height) do
        ...
        bounding_box([pad, cursor], width: info_w-pad, height: height-banner_h) do
          ...
          move_down 8
          text_box "Rencontre de Jeunesse 2018", at: [0, cursor], size: 16, style: :bold
          move_down 20
          text_box "Pass pour le weekend", at: [0, cursor], size: 13
          move_down 18
          text_box "Valide du JEU 12.10. 10:00 - DIM 15.10. 14:00", at: [0, cursor], size: 11
          move_down 14
          text_box "À présenter sur place le jour de l'événement", at: [0, cursor], size: 11
          move_down 20
          ...
          bounding_box([0, cursor], width: info_w-pad, height: height1+height2) do
            ...
            bounding_box([0, cursor], width: width1, height: height1) do
              ...
              move_down 5
              text_box "13.07.-15.07.2018", at: [0, cursor], style: :bold, size: 11
            end
            # Row 2 col 1
            bounding_box([0, cursor], width: width1, height: height2) do
              ...
              draw_special_line(-1, cursor, width1, 1.6)
              move_down 5
              text_box "Espace-Gruyère", at: [0, cursor], style: :bold, size: 9
              move_down 11
              text_box "Rue de Vevey 64", at: [0, cursor], size: 9
              move_down 9
              text_box "1630 Bulle", at: [0, cursor], size: 9
              move_down 10
              text_box "Suisse", at: [0, cursor], size: 9
            end
            ...
            bounding_box([width1 + row_pad, cursor], width: width2, height: height1) do
              ...
              move_down 5
              text_box "18:00/16:00", at: [0, cursor], style: :bold, size: 11
            end
            # Row 2 col 2
            bounding_box([width1 + row_pad, cursor], width: width2, height: height2) do
              ...
              draw_special_line(-1, cursor, width2, 1.6)
              move_down 5
              text_box "56.40CHF", at: [0, cursor], style: :bold, size: 11
            end
            move_up height1+height2
            # Row 1 col 2
            bounding_box([width1 + row_pad + width2 + row_pad, cursor], width: width3, height: height1+height2) do
              stroke_bounds if @debug
              image "#{Rails.root}/app/assets/images/orders/pdf/logo.png", width: 25, at: [width3-40,cursor+30]
              text_box "Organisateurs:", at: [0, cursor], size: 4
              move_down 7
              draw_special_line(-1, cursor, width3, 1.6)
              move_down 5
              text_box "Association Rencontre de Jeunesse", at: [0, cursor], style: :bold, size: 7
              move_down 10
              text_box "1607 Palézieux", at: [0, cursor], size: 7
              move_down 9
              text_box "Suisse", at: [0, cursor], size: 7
              move_down 9
              text_box "www.rencontredejeunesse.ch", at: [0, cursor], size: 7
            end
            # row 3
            bounding_box([0, cursor], width: info_w-pad, height: 40) do
              ...
              fill_color "000000"
              move_down 17
              text_box "Noémien Kocher", at: [0, cursor], size: 16, style: :bold
              move_down 18
              draw_special_line(-1, cursor, info_w-pad, 1.6)
            end
          end
      ...
      bounding_box([info_w+barcode_pad, cursor], width: bounds.width-info_w-2*barcode_pad, height: height) do
        ...
        move_down 5
        text_box "123456789", size: 9.6, style: :bold, at: [0, cursor], align: :center, width: bounds.width
        barecode_height = 80
        move_down barecode_height + 13
        outputter.annotate_pdf(self, x: 0 , y: cursor, height: barecode_height, xdim: scale)
        move_down 5
        text_box "#{@order.display_order_id}", size: 9.6, at: [0, cursor], character_spacing: 1.2, align: :center, width: bounds.width, style: :bold
        barecode_height = 39
        move_down barecode_height + 13
        outputter.annotate_pdf(self, x: 0 , y: cursor, height: barecode_height, xdim: scale)
        move_down 2
        ...
        fill_color "ffffff"
        move_down 3
        text_box "12345", at: [0, cursor], size: 7.7, style: :bold, align: :center, width: bounds.width
        fill_color "000000"
      end
    ...
    bounding_box([0, cursor], width: bounds.width, height: height) do
      ...
      move_down 5
      fill_color "000000"
      text_box "info@rencontredejeunesse.ch", at: [0, cursor], size: 8
      move_down 14
      draw_special_waves(0, cursor, bounds.width, 3, 0.7)
    end
