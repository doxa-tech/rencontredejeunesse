namespace :seed do
  ...
  task adeia_elements: :environment do
    ENV['elements'] = "api/comments, api/users, api/testimonies, api/posts, admin/volunteers, admin/discounts, admin/orders/events, admin/users, admin/payments, admin/orders/checkin, admin/option_orders"
